...
def train(env_id, num_timesteps, seed, save_model, load_model, model_dir, timesteps_per_actorbatch,
        ...
        num_hidden_layers, hidden_size, lr_schedule, filename, sym):
    ...
    pposgd_simple.learn(env, policy_fn, 
                        ...
                        rw_scaler=rw_scaler, filename=filename,sym=sym
                        )
    env.close()
...
def main():
    ...
    parser.add_argument('--timesteps_per_actorbatch', type=int, default=2048)
    ...
    parser.add_argument('--sym', type=str, default="invalid")
    ...
    filename = args.sym + "__" + str(args.height) + "_____" + str(args.timesteps_per_actorbatch) + "_" + str(args.clip_param) + "_" + str(args.ent_coeff) + "_" + str(args.epochs) + \
    ...
    train(args.env, num_timesteps=args.num_timesteps, seed=args.seed,
          ...
          hidden_size=args.hidden_size, lr_schedule=args.lr_schedule, filename=filename, sym=args.sym)
